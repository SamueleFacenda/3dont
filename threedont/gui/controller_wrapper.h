...
public:
  ...
  void createProject(const std::string &projectName, const std::string &dbUrl, const std::string &graphUri, const std::string &graphNamespace, bool isLocal, const std::string& originalPath, const std::string& ontologyNamespace);
  void askProjectList();
