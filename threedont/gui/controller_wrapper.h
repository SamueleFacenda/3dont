...
public:
  ...
  void createProject(const std::string &projectName, const std::string &dbUrl, const std::string &graphUri, const std::string &ontologyNamespace, bool isLocal, const std::string& originalPath, const std::string& ontologyPath);
  void askProjectList();
