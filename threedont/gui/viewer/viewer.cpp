...
void Viewer::playCameraAnimation() {
  if (_dolly->done()) {
    updateSlow();
    return;
  }
...
void Viewer::printScreen(std::string filename) {
...
QPointF Viewer::win2ndc(QPointF p) {
